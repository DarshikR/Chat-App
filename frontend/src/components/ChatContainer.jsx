...
const ChatContainer = () => {
    ...
    return (
        <div className={`flex flex-col flex-1 overflow-auto absolute z-10 top-0 left-0 right-0 bottom-0 sm:relative ${keyboardVisible ? 'pb-[env(safe-area-inset-bottom)] bg-red-700' : ''}`}>
            <ChatHeader />
