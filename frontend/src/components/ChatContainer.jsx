...
const ChatContainer = () => {
    ...
    if (isMessagesLoading || (loading && messages.length > 0)) {
        return (
            <div className="h-[var(--app-height)] flex flex-col flex-1 overflow-auto">
                <ChatHeader />
    ...
    return (
        <div className="h-[var(--app-height)] flex flex-col flex-1 overflow-auto absolute z-10 top-0 left-0 right-0 bottom-0 sm:relative bg-base-100">
            <ChatHeader />
